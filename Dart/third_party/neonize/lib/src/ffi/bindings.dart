...
/// Matches C `ptr_to_python_function_callback_bytes2` (Neonize Go export).
typedef LogCallbackBytes2Native = ffi.Void Function(
...
typedef ConnectNative =
    ffi.Void Function(
      ...
      ffi.Pointer<ffi.NativeFunction<LogCallbackBytes2Native>> logCallback,
